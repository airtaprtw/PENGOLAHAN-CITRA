...
def histogram(gambar):
    ...
    gambar_r.save('img/' + get_file_name(gambar) + '_r.jpg', 'JPEG')
    gambar_g.save('img/' + get_file_name(gambar) + '_g.jpg', 'JPEG')
    gambar_b.save('img/' + get_file_name(gambar) + '_b.jpg', 'JPEG')
...
histogram('E:\\airta drafts\\sepeda.jpg')
